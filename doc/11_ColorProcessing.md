...
<div align=center>
    ...
    <h5>1번은 Intencity를 낮춘것<br> 2번은 주황값을 제외하고 Saturation을 0으로 만든것<br> 3번은 Hue 채널을 조정시킨것</h5>
</div>
...
* $\frac{255}{R'_w}$의 의미는 이미지의 각 채널에 해당하는 모~~든 픽셀에
$R'_w$를 나눠줘 $[0, 1]$ 의 범위로 정규화(normalize)한 뒤에,
