...
1. 파노라마 만들기
   * 각각의 영상을 이어 붙여서, stitching
   * 영상이 어떤 영역이 다른 영상의 어떤 부분과 대응되는지 알면 만들 수 있겠다.
2. 가우시안 스플래팅
3. 3D모델 만들기.
...
<div align=center>
    <img src="image/2025-06-06-18-02-45.png" width="80%">
    <h5></h5>
</div>
...
<div align=center>
    <img src="image/2025-06-06-19-00-10.png" width="80%">
    <h5>초록색은 호모그래피</h5>
</div>

---

> ### 📄 5. 체커 보드에서 특징 추출이 어려운 이유.

<div align=center>
    <img src="image/2025-06-06-13-32-47.png" width="80%">
    <h5>흠.. 뭔가 그렇게 찰떡같이 잘 맞는 느낌은 아니다..</h5>
</div>

<div align=center>
    <img src="image/2025-06-06-17-03-05.png" width=80%>
</div>

#### 1). 체커 보드 이미지에서 ORB 특징 추출의 어려움

* 체커보드는 대칭적인 구조를 가지고 있어 회전이나 반사에 대해 특징 추출기가 혼동을 일으킬 수 있음.
* 따라서 권장되는 방법은 체커보드의 구조를 활용한 방법이 더 효과적이다.
  * Harris코너 검출기나 Shi_Tomasi 코너 검출기를 사용해서 체커 보드의 코너를 정확히 검출할 수 있다.
  * 또는 `findChessboardCorners` 함수를 통해 체커 보드의 코너를 정확히 검출하는데 사용할 수 있다.

> ### 참고

1. https://scikit-image.org/docs/stable/auto_examples/transform/plot_ransac.html
